...
RestoreService.run, promotion -> PromotionService.execute). Every other
governed kind stays absent from the handler map and therefore fails closed
through GovernedJobRuntime until its handler is wired and platform-validated.
"""
