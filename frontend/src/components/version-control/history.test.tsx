...
it('history_shows_origin_actor_lineage_and_optimizer_drillthrough', () => {
  ...
  for (const text of ['optimizer', 'capturing-user', 'approved-2', 'original-1', 'champion-7', 'run%2F42', 'Compare versions', 'Next history page', 'external-3']) expect(html).toContain(text)
